        ...
        *,
        ...
        if news_context and pillar.use_news_search:
            news_requirements = (
                ...
                "5b. BALANCE, AND NEVER REPEAT A GOVERNMENT LINE AS YOUR OWN. Several of "
                "these outlets are state or party-owned and are marked above. Their FACTS "
                "(a deal, a figure, an order book) are usable; their FRAMING is policy. "
                "Attribute anything contested to the outlet - 'Yicai reported that the "
                "chamber's president described...' - never state it as your finding. Do "
                "not adopt formulations like 'pan-securitisation', 'win-win cooperation', "
                "'Cold War mentality', 'long-arm jurisdiction' or 'hegemony' in your own "
                "voice. Where a claim is contested, give the European reading too: an EU "
                "screening regime looks like protectionism from Beijing and like national "
                "security from Brussels, and your reader is usually in Brussels. A post "
                "that reads as Chinese state messaging costs Seta exactly the European "
                "owners it is written for.\n"
                "6. THE CONNECTION MUST BE REAL. The link between the story and your "
                "analysis must be CAUSAL — the development changes something about how a "
                "deal gets valued, financed, approved or timed. If the only link you can "
                "write is 'this shows cross-border activity is accelerating', that is "
                "decoration, not a connection: use a DIFFERENT story from the list, or "
                "write from the pillar alone and cite no news. A post that opens on a "
                "story and then ignores it is worse than one with no news in it.\n"
                "   (Added 2026-09-13 after a TNT post opened on a bearing maker's stock "
                "listing and then argued about bearing cost — the listing had nothing to "
                "do with the argument. Seta's material is deal news, so the mismatch is "
                "rarer here, but the failure shape is the same.)\n"
                "7. Do NOT paste any URL. The link is published as the first comment.\n"
                f"8. No {self.company} in the body — the company appears only in the cta.\n"
            )
        else:
            news_requirements = ""
        ...
        if post_type == "holiday":
            ...
            if news_context and pillar.use_news_search:
                image_requirements = (
                    ...
                    "  about a signing.\n"
                    "\n"
                    "  A POLICY OR REGULATORY STORY IS NOT ABOUT LAWYERS. When the subject is\n"
                    "  a screening regime, an approval, export controls, a tariff or a review,\n"
                    "  show WHAT THE RULE GOVERNS, not the people administering it. FDI\n"
                    "  screening of a components maker -> that plant, its line, the part being\n"
                    "  made and the people making it. Export controls on machine tools -> the\n"
                    "  machine cutting metal. A tariff on EVs -> the finished cars leaving the\n"
                    "  factory or waiting at the port. Steel safeguards -> the mill.\n"
                    "  The rule is abstract; the thing it touches is not, and the thing it\n"
                    "  touches is what the reader owns or buys from.\n"
                    "  Offices, meeting rooms, people around documents and handshakes are the\n"
                    "  WRONG answer for a policy story - every advisory firm posts those and\n"
                    "  they say nothing about which rule changed or who it hits.\n"
                    "- Real people, doing the work, always. NO empty buildings, NO city skylines,\n"
                    "  NO abstract graphics, NO text, NO logos, NO branding."
                )
            else:
                image_requirements = (
                    "- image_prompt and video_prompt MUST show the INDUSTRY this post is about,\n"
                    "  at work: the plant, the line, the component, the people making or\n"
                    "  inspecting it. A post about succession in a family-owned components\n"
                    "  maker shows that workshop and the two generations in it, not an office.\n"
                    "\n"
                    "  A POLICY OR REGULATORY SUBJECT IS NOT ABOUT LAWYERS. Show WHAT THE RULE\n"
                    "  GOVERNS - FDI screening of a components maker means that plant and its\n"
                    "  line; export controls on machine tools mean the machine cutting metal;\n"
                    "  an EV tariff means the finished cars at the port. The rule is abstract;\n"
                    "  the thing it touches is not, and that is what the reader owns.\n"
                    "\n"
                    "  Meeting rooms, people around documents and handshakes are the WRONG\n"
                    "  answer - every advisory firm posts those and they say nothing about\n"
                    "  which rule changed or who it hits. Use one only if the post is\n"
                    "  literally about a negotiation.\n"
                    "  NO empty buildings, NO city skylines, NO abstract graphics.\n"
